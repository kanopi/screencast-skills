...
- The `.beads/` local development database is no longer tracked. v1.0.1
  removed the beads credential key, but the dolt database, noms journals, and
  interaction log stayed tracked and were recommitted since; `.beads/` is now
  gitignored. (#5)
